...
p_shldr_trans_jfp = max(shldr_trans_jfp)';
p_elb_trans_jfp = max(elb_trans_jfp)';
p_shldr_trans_stp = max(shldr_trans_stp)';
p_elb_trans_stp = max(elb_trans_stp)';
p_shldr_trans_net = max(shldr_trans_net)';
p_elb_trans_net = max(elb_trans_net)';
p_shldr_gen = max(shldr_gen_stp)';
p_elb_gen = max(elb_gen_stp)';
p_shldr_abs = min(shldr_gen_stp)';
p_elb_abs = min(elb_gen_stp)';
